...
<br><br>
 <ol>
  ...
  <li>Setup an admin account with credentials you will remember.</li>
   <p align="center">
    <picture>
  ...
  <li>Once the network security group is setup, create the VM after reviewing all settings.</li> 
</ol> 
